...
import { 
  Cpu, ShieldCheck, Zap, ChevronLeft, User, GraduationCap, 
  School, Lock, ArrowRight, Eye, EyeOff, CheckCircle2, XCircle
} from "lucide-react";
    ...
    <div className="h-screen w-full bg-slate-950 text-white overflow-hidden flex items-center justify-center font-sans">
      <div className="flex h-full w-full">
            ...
            <AnimatePresence mode="wait">
              ...
              {step === 1 && (
                <motion.div key="st1" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 30 }}>
                  ...
                  <h1 className="text-6xl mt-12 font-black uppercase tracking-tighter leading-[0.85] mb-8">
                    Select <br/> <span className="text-transparent" style={{ WebkitTextStroke: '1px white' }}>Protocol.</span>
                  </h1>
                  <div className="space-y-3">
                    {roles.map((r) => (
                      <button 
                        ...
                        className="w-full flex items-center cursor-pointer justify-between bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:bg-orange-600/10 hover:border-orange-500 transition-all group"
                      >
        ...
        <div className="hidden lg:block w-1/2 relative overflow-hidden border-l border-white/5">
          <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1200" className="w-full h-full object-cover brightness-50" alt="Cyber" />
