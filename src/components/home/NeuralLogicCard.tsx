    ...
    >
      ...
      <div className="absolute inset-0 z-0 opacity-60 group-hover:opacity-100 transition-opacity duration-700">
        ...
        >
          ...
          <div className="w-full h-full bg-gradient-to-br from-violet-900/20 via-black to-blue-900/20" />
        </video>
      ...
      <div className="relative z-20 h-full p-10 flex flex-col justify-between">
        ...
        <div className="space-y-4">
          <h3 className="text-5xl font-black text-white uppercase tracking-tighter italic leading-none">
            Neural <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-violet-400">Logic</span>
          </h3>
        ...
        <div className="mt-8">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-violet-600 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500" />
            ...
            <motion.div 
              ...
              className="absolute top-0 bottom-0 w-20 bg-white/20 skew-x-[30deg] z-20"
            />
          </motion.button>
        </div>
      </div>
